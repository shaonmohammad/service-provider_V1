...
#     service = googleapiclient.discovery.build('mybusinessbusinessinformation', 'v4', credentials=credentials)
#     accounts = service.accounts().list().execute()
#     account = accounts['accounts'][0]['name']
    
#     locations = service.accounts().locations().list(parent=account).execute()
#     reviews_all = []
